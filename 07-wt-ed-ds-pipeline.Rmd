...
```{r warning = FALSE, message = FALSE, results = 'hide', fig.showtext = TRUE, fig.cap = "Example plot"}
#| label: fig7-2
# Make dataset
students <- 
  tibble(
...
``` {r message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Percentage earned vs. time spent", fig.showtext = TRUE}
#| label: fig7-3
joined_dat %>%
...
``` {r message = FALSE, warning = FALSE, results = 'hide', fig.cap = "Adding a line of best fit", fig.showtext = TRUE}
#| label: fig7-4
joined_dat %>%
    ggplot(aes(x = TimeSpent, y = final_grade)) +
