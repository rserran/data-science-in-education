...
```{r fig12-1, fig.cap = "Add app password", echo = FALSE, fig.alt="This is the name for your "app password" - you can use the default generated name or provide your own that is specific to your analysis or use."}
knitr::include_graphics("./man/figures/Figure 12.1.png")
```
...
```{r fig12-2, fig.cap = "Example app password", echo = FALSE, fig.alt="Example app password. Note, this password won't work for you - you'll need to create your own."}
knitr::include_graphics("./man/figures/Figure 12.2.png")
```
...
```{r fig.cap="Network visualization"}
#| label: fig12-3
...
```{r fig.cap="Network visualization with isolated nodes removed"}
#| label: fig12-4
set.seed(42)
